      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item dropdown">
            <a class="nav-link text-dark dropdown-toggle lite" href="#" id="navbarDropdown" role="button"
              data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Browse
            </a>
            <div class="dropdown-menu lite" aria-labelledby="navbarDropdown">
              <router-link class="dropdown-item" :to="{ name: 'Home' }">Home</router-link>
              <router-link class="dropdown-item lite" :to="{ name: 'Product' }">Product</router-link>
              <router-link class="dropdown-item lite" :to="{ name: 'Category' }">Category</router-link>
            </div>
          </li>
          ...
          <li class="nav-item">
            <div id="cart">
              ...
              <router-link class="text-dark" :to="{ name: 'Cart' }"><i class="fa fa-shopping-cart"
